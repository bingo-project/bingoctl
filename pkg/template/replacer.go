...
func (r *Replacer) ReplaceBingoConfig() error {
	...
	// Replace rootPackage: github.com/bingo-project/bingo -> rootPackage: {newModule}
	if r.newModule != "" {
		str = strings.ReplaceAll(str, "rootPackage: "+BingoRootPackage, "rootPackage: "+r.newModule)
	}
