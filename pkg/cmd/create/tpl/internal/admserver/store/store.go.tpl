...
import (
	...
	"{[.RootPackage]}/internal/admserver/store/bot"
	"{[.RootPackage]}/internal/admserver/store/syscfg"
	"{[.RootPackage]}/internal/admserver/store/system"
)

//go:generate mockgen -destination mock_store.go -package store {[.RootPackage]}/internal/admserver/store IStore
