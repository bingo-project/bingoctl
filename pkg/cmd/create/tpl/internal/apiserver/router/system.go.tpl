...
import (
	...
	"{[.RootPackage]}/internal/apiserver/http/controller/v1/system"
	"{[.RootPackage]}/internal/apiserver/http/controller/v1/system/syscfg"
	"{[.RootPackage]}/internal/apiserver/http/controller/v1/system/user"
