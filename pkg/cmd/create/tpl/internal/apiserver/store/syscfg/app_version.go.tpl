...
type AppVersionStore interface {
	...
	CreateInBatch(ctx context.Context, appVersions []*model.AppVersion) error
...
func SearchAppVersion(req *v1.ListAppVersionRequest) func(db *gorm.DB) *gorm.DB {
...
func (s *appVersions) List(ctx context.Context, req *v1.ListAppVersionRequest) (count int64, ret []*model.AppVersion, err error) {
	db := s.db.WithContext(ctx).Scopes(SearchAppVersion(req))
...
func (s *appVersions) CreateInBatch(ctx context.Context, appVersions []*model.AppVersion) error {
	return s.db.WithContext(ctx).CreateInBatches(&appVersions, global.CreateBatchSize).Error
}
