...
//go:generate mockgen -destination mock_biz.go -package biz {[.RootPackage]}/internal/bot/biz IBiz

import (
	"{[.RootPackage]}/internal/bot/biz/bot"
	"{[.RootPackage]}/internal/bot/biz/syscfg"
