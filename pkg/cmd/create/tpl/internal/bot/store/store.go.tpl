...
import (
	...
	"{[.RootPackage]}/internal/bot/store/bot"
	"{[.RootPackage]}/internal/bot/store/syscfg"
)

//go:generate mockgen -destination mock_store.go -package store {[.RootPackage]}/internal/bot/store IStore
